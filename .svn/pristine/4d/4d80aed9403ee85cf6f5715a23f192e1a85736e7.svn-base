...
//-----------------------------------------------
@HSchedualObserver(executeType.PER_YEAR)
public class PER_YEAR extends HSchedualObserverer{

	public HSchedual.executeType executeType=HSchedual.executeType.PER_YEAR;
	...
	public void doObserve(HSchedualTask task){
		try {
			...
			long unit=31536000*Integer.parseInt(units);
			SimpleDateFormat format=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			if(unit<31536000) {return ;}
