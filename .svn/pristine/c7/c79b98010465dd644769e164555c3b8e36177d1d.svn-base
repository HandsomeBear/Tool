...
//-----------------------------------------------
//task.setAttribute("executeunit", "10");
//-----------------------------------------------
@HSchedualObserver(executeType.PER_DAY)
public class PER_DAY extends HSchedualObserverer{

	public HSchedual.executeType executeType=HSchedual.executeType.PER_DAY;
	...
	public void doObserve(HSchedualTask task){
		try {
			...
			long unit=24*3600*Integer.parseInt(units);
			if(unit<(24*3600)) {return;}
